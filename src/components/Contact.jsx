...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      {
        from_name: form.name,
        to_name: 'Amdadul Hoq Shabbir',
        from_email: form.email,
        to_email: 'sabbirholybangla@gmail.com',
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      <motion.div variants={slideIn('right', 'tween', 0.2, 1)} className='xl:flex-1 flex justify-center items-center xl:h-auto md:h-[550px] h-[350px]'>
        <EarthCanvas/>
      </motion.div>
    </div>
  )
